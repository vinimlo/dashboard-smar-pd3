...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            _server.py_temperature_2.set_value(
                py_temperature_2_value - 0.0006) if py_temperature_2_value > 25 else _server.py_temperature_2.set_value(py_temperature_2_value)
